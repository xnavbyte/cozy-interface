  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SibirLand — Minecraft-сервер снежной тайги" },
      {
        ...
        content: "Холодная тайга, тёплое сообщество. Выживание, свои механики и активное сообщество.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Unbounded:wght@600;800&family=Manrope:wght@400;500;600;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
